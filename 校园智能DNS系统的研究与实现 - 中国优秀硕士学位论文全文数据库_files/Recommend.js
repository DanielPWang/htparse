var ipUrl = "search.cnki.net";//此处的ip是Krs发布机器的ip地址  ，外网发布时则修改为域名。
...
function RecommendFun() {
    ...
    //if (document.URL.indexOf("http://www.cnki.net") > -1) {
    //    return;
    //}

    var userName;//$("#searchinfo")
...
function WriteActionLog(userName, cnkiUserKey, curUrl, referUrl) {
    ...
    //var userName = GetCookie("PUserName");
    //var cnkiUserKey = GetCookie("cnkiUserKey");
